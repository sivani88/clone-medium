...
admin.site.site_header = "Authors Sivani API Admin"

admin.site.site_title = "Authors Sivani API Admin Portal"

admin.site.index_title = "Welcome to Authors Sivani API Portal"